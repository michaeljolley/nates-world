...
// Map grade names to numbers for database (unique IDs 100-112 for math quiz)
const gradeMap = {
  'kindergarten': 100, '1st': 101, '2nd': 102, '3rd': 103, '4th': 104, '5th': 105,
  '6th': 106, '7th': 107, '8th': 108, '9th': 109, '10th': 110, '11th': 111, '12th': 112
}
    ...
    <div class="container">
      ...
      <template v-if="gamePhase === 'menu'">
        ...
        <div class="rules">
          <h3>How to Play</h3>
          <ul>
            <li>Answer {{ questionsPerGrade }} math questions for {{ gradeLabels[selectedGrade] }}</li>
      ...
      <template v-if="gamePhase === 'results'">
        <div class="results-card">
          ...
          <p class="score-message" v-if="score === questionsPerGrade">🏆 Perfect Score! Math genius!</p>
          ...
          <p class="score-message" v-else>📚 Keep practicing your math!</p>
...
.lightning-bg {
  ...
  pointer-events: none;
  background: 
    linear-gradient(135deg, transparent 40%, rgba(0, 200, 255, 0.03) 50%, transparent 60%),
