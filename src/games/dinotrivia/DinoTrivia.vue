...
const difficultyMap = { easy: 7, medium: 8, hard: 9 }
  ...
  <div class="trivia-wrapper" :data-difficulty="difficulty">
    ...
    <div class="container">
      ...
      <template v-if="gamePhase === 'menu'">
        <p class="subtitle">Test your dinosaur knowledge!</p>
        ...
        <div class="rules">
          <h3>How to Play</h3>
          <ul>
            <li>Answer {{ questionsPerDifficulty[difficulty] }} multiple-choice questions about dinosaurs</li>
      ...
      <template v-if="gamePhase === 'results'">
        <div class="results-card">
          ...
          <p class="score-message" v-else>📚 Keep learning about dinosaurs!</p>
...
.lightning-bg {
  ...
  pointer-events: none;
  background: 
    linear-gradient(135deg, transparent 40%, rgba(76, 175, 80, 0.03) 50%, transparent 60%),
    linear-gradient(-135deg, transparent 40%, rgba(139, 195, 74, 0.03) 50%, transparent 60%);
  z-index: 0;
}
...
.streak-display.guest:hover {
  background: linear-gradient(135deg, rgba(76, 175, 80, 0.2) 0%, rgba(139, 195, 74, 0.3) 100%);
