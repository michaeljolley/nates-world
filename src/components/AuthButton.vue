    ...
    <Teleport to="body">
      <div v-if="showModal" class="modal-overlay" @click.self="closeModal">
        <div class="modal-content">
          ...
          <h2>Sign In to Natorade</h2>
          <p>Sign in to save your scores and compete on leaderboards!</p>
          
          <div class="providers">
            <button class="provider-btn google" @click="auth.signInWithGoogle()">
            ...
            <button class="provider-btn github" @click="auth.signInWithGitHub()">
            ...
            <button class="provider-btn twitch" @click="auth.signInWithTwitch()">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                <path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z"/>
              </svg>
              Continue with Twitch
            </button>
            <button class="provider-btn discord" @click="auth.signInWithDiscord()">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
          ...
          <p class="optional">Authentication is optional. You can always play as a guest!</p>
        </div>
      </div>
    </Teleport>
  </div>
...
.modal-content {
  ...
  text-align: center;
  position: relative;
  border: 2px solid var(--accent-green, #00c853);
  box-shadow: 0 0 30px rgba(0, 200, 83, 0.3);
}

[data-theme="light"] .modal-content {
  box-shadow: 0 0 30px rgba(0, 150, 60, 0.2);
}
